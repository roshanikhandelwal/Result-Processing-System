...
//        	String eno1= txtRoll.getText();
       ...
       //	if((eno1.equals("2018") && as_id==1)||(eno1.equals("2019") && as_id==2)) {
            try {
//    			if (Integer.parseInt(txtSem.getText())==1)
//    			{
//    				JOptionPane.showMessageDialog(null,"Cannot delete value of Semester One");
//    			}
//    			else
//    			{	
					...
					st.executeUpdate();
					st.close();
					PreparedStatement st2 = Main.con.prepareStatement("update result set sem"+txtSem.getText()+"=0.0 where e_no=? ");
					st2.setString(1,txtRoll.getText() );
//					st2.setInt(2,Integer.parseInt(txtSem.getText()));
					st2.executeUpdate();
					st2.close();
