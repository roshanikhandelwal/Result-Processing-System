			 ...
			 public static void table_Cre()
			{
				try{
					...
					Class.forName("com.mysql.jdbc.Driver");
        				...
        				//CreateSql = "Create Table  Student(E_no varchar(20) not null primary key,sname varchar(25),DOB date, F_name varchar(25), M_name varchar(25), Sex char(1), As_id numeric(1), Email varchar(30), Dept_id varchar(5), Mob_no varchar(10)) ";      
        				
				//CreateSql = "Create Table Department(Dept_id varchar(5) not null primary key,Dept_name varchar(25)) ";      
        				
				//CreateSql ="Create Table Subject(As_id numeric(1)  references Academic_Session(As_id),Dept_id varchar(10) references Department(Dept_id),Sub_name varchar(100),Sub_code varchar(8),Credit_T numeric(2),Credit_P numeric(2),Sem numeric(1),primary key(As_id,Sub_code))";
				...
				//CreateSql ="Create Table Result(E_no varchar(20),sem1 numeric(3,2),sem2 numeric(3,2),sem3 numeric(3,2),sem4 numeric(3,2),sem5 numeric(3,2),sem6 numeric(3,2),sem7 numeric(3,2),sem8 numeric(3,2),OGPA numeric(3,2),primary key(E_no),foreign key(E_no) references Student(E_no))";  
